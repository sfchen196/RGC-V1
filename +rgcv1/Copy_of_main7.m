...
figure(2); annotation('textbox','String','their method','FitBoxToText','on');
for i = 1:2:7
    ff_w0_sig = i * 18;
   Result = rgcv1.init_feedforward(ff_w0_sig,pos_OFF,pos_ON,pos_V1,ff_w0_str,ff_w0_thr);
    ...
    figure(3); subplot(2,2,(i+1)/2);imagesc(opmap0); caxis([-pi/2 pi/2]); colorbar; colormap(hsv); axis xy image
