function [best_response, best_response_location, selectivity] = compute_OT(CTX_RF, RF_XX, RF_YY)
...
for i=1:n_step
    ...
    inputs = CTX_RF .* permute(grating,[size(CTX_RF,1), size(grating,1), size(grating,2)]);
